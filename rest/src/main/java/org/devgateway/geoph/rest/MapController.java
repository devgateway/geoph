...
public class MapController {
    ...
    * */
    ...
    public Page<AppMap> findMaps(@PageableDefault(page = 0, size = 20, sort = "creationDate", direction = Sort.Direction.DESC) final Pageable pageable) {
        LOGGER.debug("Find map controller called...");
