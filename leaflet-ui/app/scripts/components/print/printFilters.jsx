  ...
  render() {
    ...
    return (
      <div className="print-filters">
        ...
        {filtersSelected["sdg"] && filtersSelected["sdg"].length > 0 ?
          <div>
            <div className="print-filter-title">
              {translate('filters.sectors.gender')}
            </div>
            <div className="print-filter-list">
              <FilterList items={filtersSelected["sdg"]}/>
            </div>
          </div>
          : null}
        {filtersSelected["pdp"] && filtersSelected["pdp"].length > 0 ?
          <div>
            <div className="print-filter-title">
              {translate('filters.sectors.gender')}
            </div>
            <div className="print-filter-list">
              <FilterList items={filtersSelected["pdp"]}/>
            </div>
          </div>
          : null}
        {filtersSelected["age"] && filtersSelected["age"].length > 0 ?
          <div>
            <div className="print-filter-title">
              {translate('filters.sectors.gender')}
            </div>
            <div className="print-filter-list">
              <FilterList items={filtersSelected["age"]}/>
            </div>
          </div>
          : null}
