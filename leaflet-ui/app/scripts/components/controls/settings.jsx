          ...
          <div className="settings-container">
           ...
           <div className="list"> 
            <div className="setting">
                <select className='form-control input-sm' value={type} onChange={this.changeFundingType}>
            ...
            <div className="setting">
              <select className='form-control input-sm' value={measure} onChange={this.changeFundingMeasure}>
