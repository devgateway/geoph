        ...
        {(settings['level']) ?
          <li>
            <ul className="level">
              ...
              <li onClick={() => {
                this.set('level', 'region')
              }}>
                <div
                  className={settings['level'] == "region" ? "active" : ""}>{translate('toolview.layers.region')}</div>
              </li>
              <li onClick={() => {
                this.set('level', 'province')
              }}>
                <div
                  className={settings['level'] == "province" ? "active" : ""}>{translate('toolview.layers.province')}</div>
              </li>
              <li onClick={() => {
                this.set('level', 'municipality')
              }}>
                <div
                  className={settings['level'] == "municipality" ? "active" : ""}>{translate('toolview.layers.municipality')}</div>
              </li>
            </ul>
        ...
        {(settings['showLabels'] != undefined) ?
          <li>
            <ul className="level">
              ...
              <li onClick={() => {
                this.set('showLabels', !settings['showLabels'])
              }}>
                {settings['showLabels'] == true ? <div className="active">{translate('toolview.layers.on')}</div> :
                  <div>{translate('toolview.layers.off')}</div>}
              </li>
            </ul>
            <div className="separator"/>
          </li>
          ...
          <li>
            <ul className="level">
              ...
              <li onClick={() => {
                ...
                <div className={settings['detail'] == "low" ? "active" : ""}>{translate('toolview.layers.low')}</div>
              </li>
              <li onClick={() => {
                this.set('detail', 'medium')
              }}>
                <div
                  className={settings['detail'] == "medium" ? "active" : ""}>{translate('toolview.layers.medium')}</div>
              </li>
              <li onClick={() => {
                this.set('detail', 'high')
              }}>
                <div className={settings['detail'] == "high" ? "active" : ""}>{translate('toolview.layers.high')}</div>
              </li>
            </ul>
            <div className="separator"/>
          </li>
  ...
  renderChildren() {
    ...
    return this.props.layers.map((l) => {
      var props = {
        ...
        name: l.get('name'),
        keyName: l.get('keyName'),
        helpKey: l.get('helpKey'),
        layers: l.get('layers')
      }
...
class Component extends ControlComponent {
  ...
  render() {
    return (<div className="layers-control">
