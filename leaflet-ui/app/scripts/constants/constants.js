...
export const REQUEST_LOCATION_STATS = 'REQUEST_LOCATION_STATS';

export const RECEIVE_LOCATION_STATS = 'RECEIVE_LOCATION_STATS';
...
export const REQUEST_DELETE_MAP_OK = 'REQUEST_DELETE_MAP_OK';

export const REQUEST_STATE_RESTORE = 'REQUEST_STATE_RESTORE';
...
export const LOAD_DEFAULT_MAP_STATE = 'LOAD_DEFAULT_MAP_STATE';

export const REQUEST_SHARE_MAP_ERROR = 'REQUEST_SHARE_MAP_ERROR';

export const ACTIVATE_SAVED_MAP = 'ACTIVATE_SAVED_MAP';

export const RESET_FEATURED_MAP = 'RESET_FEATURED_MAP';

/*LAYERS events*/

export const TOGGLE_LAYER = 'TOGGLE_LAYER';

export const LOAD_LAYER_BY_ID = 'LOAD_LAYER_BY_ID';
...
export const LAYER_LOAD_REQUEST = 'LAYER_LOAD_REQUEST';
...
export const COPY_COMPARE_MAP = "COPY_COMPARE_MAP";
export const COPY_COMPARE_FILTERS = "COPY_COMPARE_FILTERS";
export const COPY_COMPARE_SETTINGS = "COPY_COMPARE_SETTINGS";
export const COPY_COMPARE_PROJECT_SEARCH = "COPY_COMPARE_PROJECT_SEARCH";
