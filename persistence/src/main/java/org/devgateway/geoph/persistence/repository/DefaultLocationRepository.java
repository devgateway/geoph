...
public class DefaultLocationRepository implements LocationRepository {
    ...
    public List<LocationProjectStatsDao> getLocationWithProjectStats(Parameters params, int trxType, int trxStatus) {
        ...
        multiSelect.add(criteriaBuilder.sum(criteriaBuilder.prod(transactionJoin.get(Transaction_.amount), projectLocationJoin.get(ProjectLocation_.utilization))));
